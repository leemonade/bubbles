...
import { AddIcon, CloudUploadIcon } from '@bubbles-ui/icons/outline';
              ...
              >
                ...
                {buttons && (
                  <Stack spacing={2} justifyContent="end" className={classes.actions}>
                    ...
                    {isNotEmpty(BUTTONS.IMPORT) && (
                      <Button
                        type="button"
                        loading={checkLoading(BUTTONS.IMPORT)}
                        onClick={(e) => onPressButton(onImport, e)}
                        leftIcon={<CloudUploadIcon />}
                      >
                        {buttonLabel(BUTTONS.IMPORT)}
                      </Button>
                    )}
