...
class ArrayField extends Component {
  ...
  renderNormalArray() {
    ...
    const Component =
      uiSchema['ui:ArrayFieldTemplate'] || ArrayFieldTemplate || DefaultNormalArrayFieldTemplate;
  ...
  renderFixedArray() {
    ...
    const Template =
      uiSchema['ui:ArrayFieldTemplate'] || ArrayFieldTemplate || DefaultFixedArrayFieldTemplate;
