...
import { ScoresBasicTable, ScoresPeriodForm } from '../../scores';
...
const Scores = ({ ...props }) => {
  ...
  return (
    <Box className={classes.root}>
      <DrawerPush opened={isOpened} size={370} className={classes.drawer}>
      ...
      <Box className={classes.mainContent}>
        ...
        <Tabs className={classes.tabHeader}>
          <TabPanel label="Tasks control">
            ...
            <Box style={{ display: 'flex', backgroundColor: 'blue' }}>
...
Scores.defaultProps = SCORES_DEFAULT_PROPS;
