...
<Button>
  Primary
</Button> <Button kind="secondary">Secondary</Button> <Button kind="tertiary">Tertiary </Button> <Button kind="danger">
  Danger
</Button> <Button kind="danger--tertiary">Danger Tertiary</Button>
...
<Button>
  Submit
</Button> <Button size="field">Submit</Button> <Button size="sm">Submit</Button> <Button size="lg">
  Submit
...
/> <Button hasIconOnly renderIcon={Add16} iconDescription="Add" tooltipPosition="bottom" /> <Button
  hasIconOnly
  renderIcon={Add16}
  iconDescription="Add"
