...
[Source code](https://github.com/leemonade/bubbles/tree/main/packages/components/src/form/Autocomplete/Autocomplete.js)
...
Autocomplete allows user input with a list of options.
...
[W3: ARIA Combobox role example](https://www.w3.org/WAI/ARIA/apg/example-index/combobox/combobox-autocomplete-none.html)

## Feedback

Help us improve this component by providing feedback, asking questions on Slack, or updating this file on
[GitHub](https://github.com/leemonade/bubbles/edit/main/packages/components/src/form/Autocomplete/Autocomplete.mdx)
