...
[Source code](https://github.com/leemonade/bubbles/tree/main/packages/components/src/form/AutocompleteUser/AutocompleteUser.js)
...
AutocompleteUser is a prefabricated component that is used to select and display an user from a list of users.

This component uses `UserDisplayItem` for the `itemComponent` and when an user is selected it transforms into an `UserCard`.
...
[GitHub](https://github.com/leemonade/bubbles/edit/main/packages/components/src/form/AutocompleteUser/AutocompleteUser.mdx)
