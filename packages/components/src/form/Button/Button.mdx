...
<ThemeProvider>
  <Group style={{ gap: 32 }} mt="24px" mb="44px" mx="2px">
    ...
    <Button color="primary" variant="outline" size="sm"> 
     ...
     <Button color="primary" variant="link" size="sm"> 
      <ExternalLinkIcon style={{ height: '1.2rem' }} /> Link Button
    </Button>
  </Group>
</ThemeProvider>
...
<ThemeProvider>
  <Group style={{ gap: 32 }} mt="24px" mb="44px" mx="2px">
    <Button color="primary" rounded  variant="outline" size="sm"> 
      Skip and go to Users <ChevronRightIcon style={{ height: '1.2rem' }} />
    </Button>
    <Button color="primary" rounded variant="default" size="sm"> 
     Mach profiles <ChevronRightIcon style={{ height: '1.2rem' }} />
    </Button>
  </Group>
</ThemeProvider>
