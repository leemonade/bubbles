...
[Source code](https://github.com/leemonade/bubbles/tree/main/packages/components/src/form/AutocompleteBadge/AutocompleteBadge.js)
...
AutocompleteBadge is a prefabricated component that is used to select and display badges selected from a list of users.

This component uses `UserDisplayItem` for the `itemComponent` and `Badge` for the `valueComponent`.
...
[GitHub](https://github.com/leemonade/bubbles/edit/main/packages/components/src/form/AutocompleteBadge/AutocompleteBadge.mdx)
